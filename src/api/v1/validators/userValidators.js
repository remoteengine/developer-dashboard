  ...
  fields.forEach(field => {
    if (req.body[field] && typeof req.body[field] === 'string') {
      try {
        ...
        // Let express-validator handle invalid JSON
      }
    }
  });
  next();
...
// Personal information update validation for file uploads (without validateUpdateData)
const validatePersonalInfoUpdateWithFiles = [
  parseJsonFields([
    'languages',
    'skills',
    'professionalBackground',
